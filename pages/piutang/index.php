<h1 class="h3 mb-4 text-gray-800">Data piutang</h1>
<div class="row">
    <div class="col">
        <div class="card mb-4">
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-6">
                        <a href="<?= BASE_URL; ?>/piutang/tambah" class="btn btn-sm btn-primary">Tambah</a>
                    </div>
                ...
                <div id="table-content">
                    <?php include 'pages/piutang/_table-piutang.php'; ?>
                </div>
            </div>
        </div>
    </div>
